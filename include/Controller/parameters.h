...
namespace control{
    ...
    /**
     * @brief vehicle state e.g. speed, acceleration
     */
    struct Chassis{
    ...
    /**
     * @brief trajectory generated by planning
     */
    struct Trajectory{
    ...
    struct MPCControllerParam{
        ...
        //sum x^T matrix_q x + u^T matrix_r u
